...
class Splash {
    ...
    async startAnimation() {
        let splashes = [
            { "message": "Que c'est bon d'être de retour !", "author": "AllFightPvP" },
            { "message": "AllFightPvP Remake, C'est un retour en enfance.", "author": "Nylun" },
            { "message": "En espérant que ce remake vous plaisent !", "author": "Nylun" }
        ];
